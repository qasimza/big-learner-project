...
const Chip = $.component(function Chip({ allProps, classes, otherProps, props, }) {
    ...
    const deleteIcon = createMemo(() => {
        ...
        if (node && node instanceof Element) {
            ...
            return (<CancelIcon class={classes.deleteIcon} onClick={handleDeleteIconClick}/>);
        }
    });
    ...
    return (<$ChipRoot as={component()} class={clsx(classes.root, otherProps.class)} disabled={clickable() && props.disabled ? true : undefined} onClick={otherProps.onClick} onKeyDown={handleKeyDown} onKeyUp={handleKeyUp} ref={element} ownerState={allProps} {...moreProps()} {...otherProps}>
      {avatar() || icon()}
